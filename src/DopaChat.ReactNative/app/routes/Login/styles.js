...
const styles = StyleSheet.create({
    ...
    MiddleContainer: { marginTop: Settings.WindowHeight / 20, backgroundColor: Colors.Gray1, borderRadius: 5, padding: 20, marginLeft: Settings.IsTablet ? Settings.WindowWidth / 6 : Settings.WindowWidth / 17, marginRight: Settings.IsTablet ? Settings.WindowWidth / 6 : Settings.WindowWidth / 17 },
