...
const styles = StyleSheet.create({
    ...
    Picker: { backgroundColor: Colors.White, borderColor: Colors.DopaGreen, borderWidth: 5, width: Settings.WindowWidth / 3, height: 50 },
    ...
    LowerContainter: { marginTop: Settings.WindowHeight / 60, marginBottom: Settings.WindowHeight / 30, alignItems: 'center' },
    DopaChatButton: { justifyContent: 'center', alignItems: 'center', width: Settings.WindowWidth / 3, height: Settings.IsTablet ? 54 : 48, backgroundColor: Colors.DopaGreen, borderRadius: 5 },
    DopaChatButtonText: { color: Colors.White, fontSize: Settings.IsTablet ? 20 : 18 },
});
